...
@Component
@Slf4j
public class HttpDeviceLoader implements DeviceLoader {
	...
	public List<Device> getDevice(String url) {
		...
		try {
			...
			if (StringUtils.isNotBlank(res)) {
				...
				JavaType type = mapper.getTypeFactory().constructParametricType(List.class, Device.class);
